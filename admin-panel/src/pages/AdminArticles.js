    ...
    return (<div className="articles-container">
      ...
      <div className="articles-action-bar">
        ...
        <div className="articles-actions">
          <button className="articles-btn articles-btn-icon icon-refresh" onClick={fetchArticles} title="Refresh">
          </button>
          
          <button className="articles-btn articles-btn-primary" onClick={() => {
            resetForm();
            setShowForm(true);
        }}>
      ...
      <div className="articles-main-card">
        ...
        {loading ? (<div className="articles-loading">
            ...
            <div className="articles-table-container">
              <table className="articles-table">
                ...
                <tbody>
                  {paginatedArticles.map((article) => (<tr key={article.id}>
                      <td>
                      ...
                      <td>
                        <span className={`articles-status-chip ${article.last_edited_at ? 'articles-status-updated' : 'articles-status-published'}`}>
                          {article.last_edited_at ? 'Updated' : 'Published'}
                        </span>
                      </td>
                      <td>
                        <div className="articles-table-actions">
                          <button className="articles-action-btn articles-action-edit" onClick={() => handleEdit(article)} title="Edit">
                          </button>
                          <button className="articles-action-btn articles-action-delete" onClick={() => handleDelete(article.id)} title="Delete">
                          </button>
                          <a href={`${API_BASE}/articles/pdf/${article.pdf_id}`} target="_blank" rel="noopener noreferrer" className="articles-action-btn articles-action-download" title="Download PDF">
                          </a>
                        </div>
                      </td>
                    </tr>))}
      ...
      {showForm && (<div className="articles-dialog-backdrop" onClick={() => setShowForm(false)}>
          <div className="articles-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="articles-form-header">
              ...
              <button className="articles-close-btn" onClick={() => setShowForm(false)} aria-label="Close">
                ×
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="articles-form-container">
                  ...
                  <div className="articles-form-section">
                    ...
                    <div className="articles-form-field">
                      ...
                      <input type="text" className="articles-form-input" placeholder="Enter a compelling title for your article..." value={formData.title} onChange={(e) => setFormData(prev => ({ ...prev, title: e.target.value }))} required/>
                    </div>
                    ...
                    <div className="articles-form-field">
                      ...
                      <textarea className="articles-form-input articles-form-textarea" rows={3} placeholder="Write a brief, compelling summary that will appear on article cards..." value={formData.short_description} onChange={(e) => setFormData(prev => ({ ...prev, short_description: e.target.value }))} required/>
                    ...
                    <div className="articles-form-field">
                      ...
                      <textarea className="articles-form-input articles-form-textarea" rows={8} placeholder="Provide comprehensive, valuable content for your article. Include detailed information, insights, and actionable guidance..." value={formData.content} onChange={(e) => setFormData(prev => ({ ...prev, content: e.target.value }))} required/>
                      <p className="articles-form-helper">
                    ...
                    <div className="articles-form-grid">
                      <div className="articles-form-field">
                        ...
                        <input type="text" className="articles-form-input" placeholder="Enter author name..." value={formData.author} onChange={(e) => setFormData(prev => ({ ...prev, author: e.target.value }))} required/>
                      </div>
                      ...
                      <div className="articles-form-field">
                        ...
                        <input type="date" className="articles-form-input" value={formData.publish_date} onChange={(e) => setFormData(prev => ({ ...prev, publish_date: e.target.value }))}/>
                        <p className="articles-form-helper">
                  ...
                  <div className="articles-form-section">
                    ...
                    <div className="articles-upload-grid">
                      ...
                      <div className="articles-form-field">
                        ...
                        <div className="articles-upload-zone" onClick={() => document.getElementById('image-upload')?.click()}>
                      ...
                      <div className="articles-form-field">
                        ...
                        <div className="articles-upload-zone pdf" onClick={() => document.getElementById('pdf-upload')?.click()}>
                    ...
                    {!editingId && (<div className="articles-upload-required">
              ...
              <div className="articles-form-footer">
                ...
                <div className="articles-form-footer-actions">
                  <button type="button" className="articles-form-btn articles-form-btn-cancel" onClick={() => setShowForm(false)}>
                    Cancel
                  </button>
                  
                  <button type="submit" className="articles-form-btn articles-form-btn-submit" disabled={submitting}>
                    {submitting ? (<div className="articles-form-btn-loading">
                        <div className="articles-form-spinner"></div>
                        <span>Saving...</span>
                      </div>) : (<span>{editingId ? 'Update Article' : 'Create Article'}</span>)}
                  </button>
                </div>
              </div>
            </form>
