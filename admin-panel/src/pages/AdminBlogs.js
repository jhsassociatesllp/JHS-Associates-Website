    ...
    return (<div className="blogs-container">
      ...
      <div className="blogs-action-bar">
        ...
        <div className="blogs-actions">
          <button className="blogs-btn blogs-btn-icon icon-refresh" onClick={fetchBlogs} title="Refresh">
          </button>
          
          <button className="blogs-btn blogs-btn-primary" onClick={() => {
            resetForm();
            setShowForm(true);
        }}>
      ...
      <div className="blogs-main-card">
        ...
        {loading ? (<div className="blogs-loading">
            ...
            <div className="blogs-table-container">
              <table className="blogs-table">
                ...
                <tbody>
                  {paginatedBlogs.map((blog) => (<tr key={blog.id}>
                      <td>
                      ...
                      <td>
                        <span className={`blogs-status-chip ${blog.last_edited_at ? 'blogs-status-updated' : 'blogs-status-published'}`}>
                          {blog.last_edited_at ? 'Updated' : 'Published'}
                        </span>
                      </td>
                      <td>
                        <div className="blogs-table-actions">
                          <button className="blogs-action-btn blogs-action-edit" onClick={() => handleEdit(blog)} title="Edit">
                          </button>
                          <button className="blogs-action-btn blogs-action-delete" onClick={() => handleDelete(blog.id)} title="Delete">
                          </button>
                          <a href={`${API_BASE}/blogs/image/${blog.image_id}`} target="_blank" rel="noopener noreferrer" className="blogs-action-btn blogs-action-view" title="View Image">
                          </a>
                        </div>
                      </td>
                    </tr>))}
      ...
      {showForm && (<div className="blogs-dialog-backdrop" onClick={() => setShowForm(false)}>
          <div className="blogs-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="blogs-form-header">
              ...
              <button className="blogs-close-btn" onClick={() => setShowForm(false)} aria-label="Close">
                ×
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="blogs-form-container">
                  ...
                  <div className="blogs-form-section">
                    ...
                    <div className="blogs-form-field">
                      ...
                      <input type="text" className="blogs-form-input" placeholder="Enter a compelling title for your blog post..." value={formData.title} onChange={(e) => setFormData(prev => ({ ...prev, title: e.target.value }))} required/>
                    </div>
                    ...
                    <div className="blogs-form-field">
                      ...
                      <textarea className="blogs-form-input blogs-form-textarea" rows={3} placeholder="Write a brief, compelling summary that will appear on blog cards..." value={formData.short_description} onChange={(e) => setFormData(prev => ({ ...prev, short_description: e.target.value }))} required/>
                    ...
                    <div className="blogs-form-field">
                      ...
                      <textarea className="blogs-form-input blogs-form-textarea" rows={8} placeholder="Write comprehensive, valuable content for your blog post. Include detailed information, insights, and engaging storytelling..." value={formData.content} onChange={(e) => setFormData(prev => ({ ...prev, content: e.target.value }))} required/>
                      <p className="blogs-form-helper">
                    ...
                    <div className="blogs-form-grid">
                      <div className="blogs-form-field">
                        ...
                        <input type="text" className="blogs-form-input" placeholder="Enter author name..." value={formData.author} onChange={(e) => setFormData(prev => ({ ...prev, author: e.target.value }))} required/>
                      </div>
                      ...
                      <div className="blogs-form-field">
                        ...
                        <select className="blogs-form-select" value={formData.category} onChange={(e) => setFormData(prev => ({ ...prev, category: e.target.value }))} required>
                      ...
                      <div className="blogs-form-field">
                        ...
                        <input type="date" className="blogs-form-input" value={formData.publish_date} onChange={(e) => setFormData(prev => ({ ...prev, publish_date: e.target.value }))}/>
                        <p className="blogs-form-helper">
                  ...
                  <div className="blogs-form-section">
                    ...
                    <div className="blogs-form-field">
                      ...
                      <div className="blogs-upload-zone" onClick={() => document.getElementById('image-upload')?.click()}>
                    ...
                    {!editingId && (<div className="blogs-upload-required">
              ...
              <div className="blogs-form-footer">
                ...
                <div className="blogs-form-footer-actions">
                  <button type="button" className="blogs-form-btn blogs-form-btn-cancel" onClick={() => setShowForm(false)}>
                    Cancel
                  </button>
                  
                  <button type="submit" className="blogs-form-btn blogs-form-btn-submit" disabled={submitting}>
                    {submitting ? (<div className="blogs-form-btn-loading">
                        <div className="blogs-form-spinner"></div>
                        <span>Saving...</span>
                      </div>) : (<span>{editingId ? 'Update Blog Post' : 'Create Blog Post'}</span>)}
                  </button>
                </div>
              </div>
            </form>
