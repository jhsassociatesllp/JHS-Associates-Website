...
const PARTNERS = [
  ...
  { name: 'Taher Pepermintwala', image: imageUrl('Taher-Pepermintwala-removebg-preview.png'), qualifications: 'B.Com, FCA, CISA', designation: 'Assurance & Tech | SOC | Audit Expert', email: 'taher.pepermintwala@jhsassociates.in', linkedin: 'https://www.linkedin.com/in/taherpepermintwala/'},
