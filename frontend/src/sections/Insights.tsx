...
export default function Insights() {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = imageUrl('Taxation2.webp');
      ...
      <div className="insights__container">
        ...
        <div className="insights__card insights__card--blogs" ref={leftCardRef}>
          <div
            ...
            style={{
              backgroundImage: blogImageLoaded ? `url(${imageUrl('Taxation2.webp')})` : 'none'
            }}
          ></div>
          ...
          <div className="insights__card-content">
            ...
            <Link to="/blog" className="insights__btn insights__btn--accent">
              READ NOW
        ...
        <div className="insights__right-col">
          ...
          <div className="insights__card insights__card--podcast" ref={rightTopRef}>
            <div className="insights__card-content">
              ...
              <Link to="/podcasts" className="insights__btn insights__btn--accent">
                EXPLORE THE SERIES
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="5" y1="12" x2="19" y2="12"></line>
                  <polyline points="12 5 19 12 12 19"></polyline>
