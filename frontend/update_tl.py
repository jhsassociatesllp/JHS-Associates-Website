...
file_path = r'f:\Maaz\JHS-Associates-Website\frontend\src\components\Insights\ThoughtLeadership.css'
...
css = re.sub(
    r'/\*\s*Purple/violet gradient.*?\.tl-hero__title em\s*\{[^}]+\}',
    r'.tl-hero__title em {\n  font-style: normal;\n}',
    css, flags=re.DOTALL
)

css = re.sub(
    r'\.tl-hero__eyebrow\s*\{[^}]+\}',
...
print('Updated ThoughtLeadership.css via Python')
